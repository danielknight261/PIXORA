/**
 * Map Gelato Classic Semi-Glossy Paper Poster mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15933359161688";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\156e90ff-19df-4a3c-8621-a58f29a5b565\\9134c01c-c325-437c-add7-f78926e9243f";
const IMAGE_ORDER = [
  "Simple.webp",
  "Close-Up-Lobby-Powder-0.webp",
  "Bedroom-Modern-Beige-1.webp",
];
const REPORT_PATH = "downloads/semi-glossy-mockup-upload-report.json";
const VARIANT_PATH = "downloads/semi-glossy-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "semi-glossy-poster-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/semi-glossy-poster-gallery.json";
...
function parseFolder(name) {
  const m = name.match(/^flat_(.+)_170-gsm-65lb-coated-silk_4-0_(hor|ver)$/i);
  if (!m) return null;
...
<div data-gelato-customization="1"></div>`,
        seo: {
          title: "Classic Semi-Glossy Paper Poster",
          description:
            "Personalised classic semi-glossy paper posters. Upload your photo, preview a live mockup, then we print and ship.",
        },
      },
    }
  );
