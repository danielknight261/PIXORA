/**
 * Map Gelato Foam Square mockups (Simple first).
 * Pack only has white edge mockups for 8x8, 16x16, 24x24 — reuse white for black
 * when matching those sizes; leave other sizes unmatched unless folders exist.
 */
...
const PRODUCT_ID = "gid://shopify/Product/15942729957720";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\3cb1ebff-b5a2-4ec8-a397-c6a46c1f035c";
const IMAGE_ORDER = ["Simple.webp", "Home-Office-Parisian-White-2.webp"];
const REPORT_PATH = "downloads/foam-square-gallery-upload-report.json";
const VARIANT_PATH = "downloads/foam-square-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "foam-square-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/foam-square-variant-gallery.json";
...
function matches(meta, variant) {
  // Pack only includes white mockups — apply by size to both black and white
