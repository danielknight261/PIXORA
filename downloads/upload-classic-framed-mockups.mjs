/**
 * Map Gelato Classic Semi-Glossy Wooden Framed Poster mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15938140602712";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\eae9a845-7330-4b70-b7c6-2c22846d02e4";
const IMAGE_ORDER = [
  "Simple.webp",
  "Kitchen-Japanese-White-1.webp",
  "Bedroom-Room-Parisian-White-0.webp",
];
const REPORT_PATH = "downloads/classic-framed-gallery-upload-report.json";
const VARIANT_PATH = "downloads/classic-framed-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "classic-framed-poster-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/classic-framed-variant-gallery.json";

const FOLDER_RE =
  /^framed_poster_mounted_.+?_(black|dark-wood|natural-wood|white)_wood_w12xt22-mm_plexiglass_(.+?)_170-gsm-65lb-coated-silk_4-0_(hor|ver)$/i;
