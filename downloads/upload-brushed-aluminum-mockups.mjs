/**
 * Map Gelato Brushed Aluminum Print mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15942566609240";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\60e17c81-d2dd-464f-bd22-c3ec06e9d29e";
const IMAGE_ORDER = [
  "Simple.webp",
  "Close-Up-Bed-Room-White-0.webp",
  "Lobby-Parisian-Beige-0.webp",
];
const REPORT_PATH = "downloads/brushed-aluminum-gallery-upload-report.json";
const VARIANT_PATH = "downloads/brushed-aluminum-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "brushed-aluminum-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/brushed-aluminum-variant-gallery.json";

const FOLDER_RE =
  /^metallic_\d+x\d+-mm-(\d+)x(\d+)-inch_3-mm-silver-brushed_hor-grain_4-0_(hor|ver)$/i;
