  ...
  await gql(
    ...
    }`,
    {
      product: {
        id: PRODUCT_ID,
        vendor: "SnapzDaddy",
        descriptionHtml: `<p>Personalised fine art posters from SnapzDaddy. Upload your photo, preview it on a live product mockup, and we print and ship to your door.</p>
<ul>
