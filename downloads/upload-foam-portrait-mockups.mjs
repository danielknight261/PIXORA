/**
 * Map Gelato Foam Portrait mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15942726386008";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\b18958a4-c157-480c-929c-012eee8950fc";
const IMAGE_ORDER = ["Simple.webp", "Home-Office-Japanese-White-0.webp"];
const REPORT_PATH = "downloads/foam-portrait-gallery-upload-report.json";
const VARIANT_PATH = "downloads/foam-portrait-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "foam-portrait-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/foam-portrait-variant-gallery.json";
...
function matches(meta, variant) {
  ...
  // Foam Portrait is vertical-only product; accept portrait or blank orient
  if (variant.orient && variant.orient !== "portrait" && !meta.square) {
