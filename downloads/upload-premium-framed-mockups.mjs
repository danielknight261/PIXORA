/**
 * Map Gelato Premium Semi-Glossy Wooden Framed Poster mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15938229141848";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\e1a0ab0f-6bc8-42f0-834d-b29e1cbd6987";
const IMAGE_ORDER = [
  "Simple.webp",
  "Lobby-Parisian-Beige-0.webp",
  "Bedroom-Creative-Green-0.webp",
];
const REPORT_PATH = "downloads/premium-framed-gallery-upload-report.json";
const VARIANT_PATH = "downloads/premium-framed-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "premium-framed-poster-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/premium-framed-variant-gallery.json";

const FOLDER_RE =
  /^framed_poster_mounted_.+?_(black|dark-wood|natural-wood|white)_wood_w12xt22-mm_plexiglass_(.+?)_200-gsm-80lb-coated-silk_4-0_(hor|ver)$/i;
