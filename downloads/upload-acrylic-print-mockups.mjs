/**
 * Map Gelato Acrylic Print mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15942730056024";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\ed111b8b-5491-48f6-91f9-0f1413f51313";
const IMAGE_ORDER = [
  "Simple.webp",
  "Close-Up-Living-Room-Green-0.webp",
  "Home-Office-Creative-Blue-0.webp",
];
const REPORT_PATH = "downloads/acrylic-print-gallery-upload-report.json";
const VARIANT_PATH = "downloads/acrylic-print-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "acrylic-print-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/acrylic-print-variant-gallery.json";

const FOLDER_RE =
  /^acrylic_\d+x\d+-mm-(\d+)x(\d+)-inch_4-mm_4-0_(hor|ver)$/i;
