/**
 * Map Gelato Aluminum Print mockups (Simple first).
 */
...
const PRODUCT_ID = "gid://shopify/Product/15942729466200";
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\34ed5463-ac7c-43e3-bf32-bcf10a3a5647";
const IMAGE_ORDER = [
  "Simple.webp",
  "Close-Up-Modern-Living-Room-Beige-0.webp",
  "Living-Room-White-1.webp",
];
const REPORT_PATH = "downloads/aluminum-print-gallery-upload-report.json";
const VARIANT_PATH = "downloads/aluminum-print-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "aluminum-print-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/aluminum-print-variant-gallery.json";

const FOLDER_RE =
  /^metallic_\d+x\d+-mm-(\d+)x(\d+)-inch_3-mm_4-0_(hor|ver)$/i;
