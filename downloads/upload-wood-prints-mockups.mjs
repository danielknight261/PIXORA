/**
 * Map Gelato Wood Prints mockups (Simple first).
 */
...
const MOCKUP_ROOT =
  "c:\\Users\\HughesHub\\Downloads\\65b82eef-4ed7-449b-806b-afc7bc461064";
const IMAGE_ORDER = [
  "Simple.webp",
  "Home-Office-Japanese-White-0.webp",
  "Bedroom-Kids-White-2.webp",
];
const REPORT_PATH = "downloads/wood-prints-gallery-upload-report.json";
const VARIANT_PATH = "downloads/wood-prints-variants-classed.json";
const SNIPPET_PATH = path.join(
  "apps",
  "shopify-theme",
  "snippets",
  "wood-prints-gallery-data.liquid"
);
const GALLERY_JSON = "downloads/wood-prints-variant-gallery.json";

const FOLDER_RE =
  /^wood_\d+x\d+-mm-(\d+)x(\d+)-inch_lined-plywood_(10|20)-mm_hor-grain_4-0_(hor|ver)$/i;
...
function matches(meta, variant) {
  if (meta.thickness && variant.thickness && meta.thickness !== variant.thickness)
    return false;
